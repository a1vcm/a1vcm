...
### 👾 Featured Projects
* **ML/AI:** DronePath | AutoLaw | PathFinder
* **Game Dev:** The First Bloom
...
| **AI/ML & Data Science** | TensorFlow, PyTorch, Keras, scikit-learn, Pandas, NumPy, LangGraph, Gemini |
| **Web & Backend** | React, Next.js, Node.js, FastAPI, PostgreSQL, BetterAuth, Tailwind, Vercel |
| **DevOps & Tools** | Docker, Linux, Git/GitHub, CI/CD, Agile, Figma |
